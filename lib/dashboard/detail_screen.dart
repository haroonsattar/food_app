      ...
      body: SafeArea(
        child: NestedScrollView(
          ...
          body: ScrollableListTabView(
            ...
            style: TextStyle(color: Colors.teal , fontFamily: Bold , fontSize: 25),
            tabs: [
              ScrollableListTab(
                tab: const ListTab(
                    ...
                    activeBackgroundColor: MyColors.primaryColor,
                ...
                body: ListView.builder(
                  ...
                  itemBuilder: (_, index) => Column(
                    ...
                    children: [
                      ListTile(
                        title: Text('Chicken Tikka Pizz' , style: const TextStyle(fontFamily: Bold),),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: Color(0xffea7676).withOpacity(0.5)),
                            child: Center(
                              child: Text('🔥 Trendy' , style: TextStyle( fontSize: 14,color: blackColor , fontFamily: Medium),),
                            ),
                          )
                        ],
                      ),
